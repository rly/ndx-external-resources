...
# Next Steps for ndx-external-resources Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-external-resources directory.
...
`spec/ndx-external-resources.namespace.yaml` and
`spec/ndx-external-resources.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-external-resources
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/rly/ndx-external-resources/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).

9. Publish your updated extension on [PyPI](https://pypi.org/).
    - Follow these directions: https://packaging.python.org/tutorials/packaging-projects/
    - You may need to modify `setup.py`
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-external-resources/0.1.0
...
`staged-extensions/ndx-external-resources`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-external-resources
    ```

13. Edit `staged-extensions/ndx-external-resources/ndx-meta.yaml`
with information on where to find your NWB extension.
    ...
    - You may copy and modify the following YAML that was auto-generated:
      ...
      version: 0.1.0
      src: https://github.com/rly/ndx-external-resources
      pip: https://pypi.org/project/ndx-external-resources/
      license: BSD 3-Clause
      maintainers: 
        - rly
      ```

14. Edit `staged-extensions/ndx-external-resources/README.md`
to add information about your extension. You may copy it from
`ndx-external-resources/README.md`.

  ```bash
  cp ndx-external-resources/README.md staged-extensions/ndx-external-resources/README.md
  ```

15. Add and commit your changes to Git and push your changes to GitHub.
```
cd staged-extensions
git add ndx-external-resources
git commit -m "Add new catalog entry for ndx-external-resources" .
git push
```
...
ndx-external-resources-record will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-external-resources GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-external-resources-record repository on GitHub.
